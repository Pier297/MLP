...
if __name__ == '__main__':
    ...
    plot_learning_curves(best_results['trials'], name=best_hyperparameters['loss_function'], highlight_best=True, file_name='MLP/experiments/results/monk3/errors.png')
