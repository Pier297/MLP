...
if __name__ == '__main__':
    ...
    plot_weights_norms(best_results["trials"][best_i]["weights_norms"], title='Weights norm during model selection')
    plot_gradient_norms(best_results["trials"][best_i]["gradient_norms"], title='Gradient norm during model selection')

    # Plot the weights and gradient norm during the final training
    plot_weights_norms(final_results['weights_norms'], title='Weights norm during final training')
    plot_gradient_norms(final_results['gradient_norms'], title='Gradient norm during final training') """
