...
), in_dimension=17, out_dimension=1, train_X=train_X, train_Y=train_Y, val_X=val_X, val_Y=val_Y, MAX_UNLUCKY_STEPS = 150, MAX_EPOCHS = 250, seed=seed)
...
optimizer = GradientDescent(loss_function=loss_func, lr=best_hyperparameters["lr"], l2=best_hyperparameters["L2"], momentum=best_hyperparameters["momentum"], BATCH_SIZE=best_hyperparameters["BATCH_SIZE"])
