...
if __name__ == '__main__':
    ...
    # 'loss_function': 'Cross Entropy', 'lr': 0.4, 'l2': 0.001, 'momentum': 0.6, 'hidden_layers': ([('tanh', 3)], 'sigmoid'),
    ...
    best_hyperparameters, best_results = grid_search(hyperparameters, training, 1) #TODO: cpu_count())
    ...
    plot_learning_curves(best_results['trials'], name=best_hyperparameters['loss_function'], highlight_best=True, file_name='MLP/experiments/results/monk1/errors.png')
